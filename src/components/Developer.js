    ...
    render() {
        return (
            <li>
                ...
                <button onClick={() => this.props.deleteDeveloperProps(this.props.developer.id)}>Delete</button>
                <Link to={`/update/${this.props.developer.id}`}>Update</Link>

                {this.props.developer.hiredFrom ?
                    <p>Developer hired from {this.props.developer.hiredFrom} to {this.props.developer.hiredTo}</p>
                    :
                    <div>
                        <label>Hire:</label>
